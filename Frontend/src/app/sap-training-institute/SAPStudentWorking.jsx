...
function SAPStudentWorking() {
  return (
    <div className="w-full  max-w-[1380px] mx-auto flex flex-col md:flex-row items-center justify-between gap-5 md:gap-[40px] py-5 md:py-5  px-[20px] md:px-24 ">
...
export default SAPStudentWorking;
