        ...
        <div className="w-full  md:max-h-[100vh] max-w-[1380px] mx-auto flex flex-col md:flex-row items-center justify-between gap-y-3  lg:gap-x-6 py-5 md:py-10  px-5 md:px-24 ">
            <div className='w-full lg:hidden inline'>
                <div className='w-full text-[#042A76] text-xl font-bold text-center '>
                    <span className="text-[#E87D1A]">D</span>evelop Your Bright Future in 
                    <span className='text-[#00A2E7]'> DevOps</span>

                </div>

                <div className='w-full text-[#232D63] text-base   font-bold flex justify-center gap-x-1 lg:gap-x-2 text-center pt-1'>
                    <div><span className="text-[#E87D1A]">J</span>oin EME Academy for the Best Training in DevOps
                ...
                <div className='w-full flex flex-col gap-y-3 justify-center items-start min-[450px]:px-5 min-[550px]:px-10'>
                    ...
                    <div className='w-full  flex justify-between  '>
                        <div className='  text-black text-xs  font-semibold flex  flex-col items-start gap-y-3  '>
                            ...
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Practical Assignment
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Industry Expert Trainers
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Project-based Learning
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Online/Offline Modes
                            </div>

                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Real-time Projects 
                            </div>
                        ...
                        <div className='  text-black text-xs  font-semibold flex   flex-col items  gap-y-3 '>
                            ...
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Intensive Training 
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Hands-on Experience
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Recognized Certification
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Placement Support
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Wide Industrial Exposure
                            </div>
            ...
            <div className='hidden w-[70%] lg:flex flex-col gap-y-10 items-start justify-start '>
                <div className='w-full hidden lg:inline'>
                    <div className='w-full text-[#232D63] lg:leading-9 lg:text-3xl  font-bold  text-start '>
                        <span className="text-[#E87D1A]">D</span>evelop Your Bright Future in     <span className='text-[#00A2E7]'>DevOps</span>
                ...
                <div className='w-full flex flex-col gap-y-3 justify-center items-start  '>
                    ...
                    <div className='w-full  flex justify-start   items-center gap-x-3 '>
                        ...
                        <div className=' text-black text-sm  font-semibold flex   gap-x-2 '>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Recognised Certification
                            </div>
                    ...
                    <div className='w-full  flex justify-start   items-center gap-x-2 '>
                        <div className=' text-black text-sm  font-semibold flex   gap-x-1  '>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span> Online/Offline Modes
                            </div>
                            <div>
                        ...
                        <div className=' text-black text-sm  font-semibold flex   gap-x-1 '>
                            ...
                            <div>
                                <span className='text-[#00A2E7]'>✦</span>  Real-time Projects  Certificate
                            </div>
                            <div>
                                <span className='text-[#00A2E7]'>✦</span>  Wide Industrial Exposure
                            </div>
...
export default DevopsHeroLanding