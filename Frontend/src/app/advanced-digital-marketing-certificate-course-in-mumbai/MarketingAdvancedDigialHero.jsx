...
export default function MarketingAdvancedDigialHero({
  ...
  return (
    <>
      <div className=" w-full flex flex-col lg:flex-row justify-center gap-5 lg:gap-[50px] items-start  py-[20px] px-[20px] md:px-24  max-w-[1380px] mx-auto ">
        ...
        <div className="w-full lg:w-[35%] flex items-center lg:items-start lg:pt-[40px]">
          <Image
            ...
            src="https://eme25.s3.ap-south-1.amazonaws.com/assets/images/Digital_Marketing_Course/AdvDM_Hero.svg"
            width={100}
            height={100}
            alt="team"
          />
