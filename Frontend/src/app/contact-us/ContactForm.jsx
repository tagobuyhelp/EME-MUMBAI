...
export default function ContactForm(_this) {
  ...
  return (
    <div className="w-full min-h-[250px] md:w-auto md:h-[420px] px-4 py-4 md:px-6  flex flex-col rounded-2xl justify-center items-center gap-[14px] bg-[#ffffff] border border-[#CED4DA] shadow-[0px_1px_2px_0px_rgba(10,10,10,0.20)] md:shadow-[0px_1px_2px_0px_rgba(10,10,10,0.20)] md:border md:border-[#CED4DA] lg:gap-4">
      <div className="w-full flex flex-col justify-start gap-[2px] border-l-4 border-[#0057E2] ">
        ...
        <div className="text-[#E87D1A] text-[13px] font-[600] pl-2">
          We&apos;d love for you to take a moment to fill out this form. Thank
          you!
        </div>
      </div>
      {formVisible ? (
          ...
          {(_this.Courses === "All Course" ||
            ...
            <div className="w-full">
              {_this.SelectCourses ? (
                ...
                //   }}
                // >
                //   <SelectTrigger className="rounded-[4px] h-9 shadow-[0px_1px_2px_0px_rgba(10,10,10,0.10)] text-[#000] outline outline-1 outline-[#CED4DA]    px-2 py-[6px] w-full     bg-[#ffffff] placeholder:text-[#666] placeholder:text-[12px] lg:placeholder:text-[14px] placeholder:font-[400]  focus:outline-none focus:placeholder:text-blue-500  focus:ring-1 focus:ring-blue-500  transition-colors">
