  ...
  const features = [
    {
      ...
      description:
        "Learn to design realistic characters, objects, and environments.",
    },
    {
      title: "Animation Techniques",
      description:
        "Master character movements, expressions, and storytelling through animation.",
    },
    {
      title: "Lighting & Rendering",
      description:
        "Understand how to bring depth, realism, and cinematic quality to your projects.",
    },
    {
      title: "Compositing & VFX",
      description:
        "Discover the art of combining live-action with digital effects for movies, ads, and games.",
    },
  ];
          ...
          <div className="flex-1 lg:w-[65%] mt-6 md:mt-0">
            <div className="mb-6">
              <h1 className="text-[18px] md:text-[22px] font-bold mb-4">
                ...
                <span className="text-[#E87D1A]">
                  3D Animation & VFX Courses
                </span>
              </h1>
              <p className="text-[12px] md:text-[14px] text-[#7F7879] leading-relaxed mb-6">
                Master industry-ready skills in animation, visual effects, and
                creative storytelling.
              </p>
              <p className="text-[12px] md:text-[14px] text-[#2D292D] leading-relaxed mb-6">
                3D Animation and Visual Effects (VFX) are at the heart of
                today&apos;s entertainment, gaming, advertising, and film
                industries. From creating lifelike characters to designing
                breathtaking visual worlds, this field allows you to transform
                creativity into stunning visuals that captivate audiences.
              </p>
              <p className="text-[12px] md:text-[14px] text-[#2D292D] leading-relaxed mb-8">
                Our 3D Animation & VFX course is designed to give you hands-on
                training in:
              </p>
            </div>
