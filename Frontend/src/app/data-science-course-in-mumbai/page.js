...
export const metadata = {
  title: "Best Data Science Institute in Mumbai With 100 % Placement",
  description:
    "Enroll in the best data science institute in Mumbai, best data science training institute in Mumbai with affordable data science course fees in Mumbai.",
  keywords: [
    "best data science training institute in Mumbai",
    "data science course in Mumbai",
    "data science course in Mumbai fees",
    "best data science course in Mumbai",
    "data science course fees in Mumbai",
    "data science course in Mumbai offline",
  ],
  alternates: {
    canonical: "https://mumbai.emeacademy.co.in/data-science-course-in-mumbai",
  },
};
