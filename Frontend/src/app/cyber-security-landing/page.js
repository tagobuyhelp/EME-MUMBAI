...
const careerProspectsData = {
  ...
  image: "/assets/images/Cyber_Security/CSCareerProspectsImage.svg",
  ...
  return (
    ...
    >
      ...
      <div id="" className="flex w-full bg-[#ffffff] py-4">
        <WhyChooseEMECard
          {..._this}
          backgroundImage="/assets/images/Cyber_Security/CSWhyChoose.png"
        />
      </div>{" "}
      ...
      <CoursesLandingFooter courseName="Cyber Security Course" {..._this}/>
