...
import GDStudentPortfolio from "../maincourse/graphic-design/GDStudentPortfolio";
import FeaturedIn from "@/components/common/FeaturedIn";
import GDStudentWork from "../maincourse/graphic-design/GDStudentWork";
...
export default function page() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-contain bg-no-repeat bg-[#F4FBFE] bg-[url('https://eme25.s3.ap-south-1.amazonaws.com/assets/images/Graphic_Designing/GDMaincourseHero.png')] xs:h-[460px] md:h-[520px] bg-cover bg-center bg-no-repeat">
