...
export default function DMProDetails() {
    ...
    return (
        <div className='w-full  max-w-[1380px] mx-auto flex flex-col items-start gap-[20px] py-[20px]  px-[20px] md:px-24'>
            ...
            <div className='w-full h-auto border-[1px] border-[#EEEEEE] rounded-[16px] overflow-hidden'>
                ...
                <button className="flex text-[#fff] text-xs lg:text-[14px] rounded-md bg-[#0057E2] hover:bg-[#00a2e7]/90 px-[10px] lg:px-[160px] py-[12px] lg:py-[16px] font-[600] gap-2.5 group" onClick={() => { setIsModalOpen(true) }}>
                    <div>Explore Now</div>
                     <ArrowRight size={18} />
                </button>
                </div>
