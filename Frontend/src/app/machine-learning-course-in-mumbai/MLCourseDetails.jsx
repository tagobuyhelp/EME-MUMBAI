...
export default function MLCourseDetails({
    Courses,
    SelectCourses,
    email_sender,
    Brochure,
    ...
    return (
        <div className='w-full  max-w-[1380px] mx-auto flex flex-col items-start gap-[20px] py-[20px]  px-[20px] md:px-24'>
            ...
            <div className='w-full h-auto border-[1px] border-[#EEEEEE] rounded-[16px] overflow-hidden'>
                ...
                {/* Icons and Details */}
                <div className='flex  flex-col items-center justify-center gap-[12px] py-[4px] '>
                ...
                <div className='flex flex-col justify-start gap-[14px] py-[12px] '>
