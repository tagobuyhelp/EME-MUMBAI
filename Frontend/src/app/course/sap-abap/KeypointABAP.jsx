...
export default function KeypointABAP() {
    const data = [
        {
            name: 'Suitable for :',
            id: 1,
            ...
            decs: <div>
                <div className='flex items-start justify-center  gap-2'>
                    ...
                    <p>BCA, MCA, B.TECH & M.TECH Candidate in IT or Computer Application</p>
                </div>
            </div>
        },
        {
