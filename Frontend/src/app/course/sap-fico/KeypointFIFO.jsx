...
export default function KeypointFIFO() {
  const data = [
    {
      name: "Suitable for :",
      id: 1,
      ...
      decs: (
        <div>
          <div className="flex items-start justify-center  gap-2">
            ...
            <p>
              Finance / Account Professionals/ with CS, CNS, ICWA, B.Com, M.Com,
              CA, CFA, MBA (Finance) backgrounds looking for better prospects
              and higher pay packages or Overseas Jobs.
            </p>
          </div>
        </div>
      ),
      ...
      decs: (
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <p>Consultant Principal Consultant</p>
          </div>
        </div>
      ),
    },
