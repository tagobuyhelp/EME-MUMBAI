...
export default function SapHero({
  ...
  return (
    <>
      <div className=" w-full flex flex-col lg:flex-row justify-center gap-5 lg:gap-[40px] items-start  py-[26px] px-[20px] md:px-15  max-w-[1380px] mx-auto ">
        <div className="w-full lg:w-[50%] pt-[18px] lg:pt-[30px]h-full flex flex-col item-center lg:items-start gap-y-4 lg:gap-[15px] text-steelblue">
          ...
          <h1 className="max-w-[673px] lg:w-full lg:h-auto text-[24px] lg:text-[38px] leading-[28px] lg:leading-[52px] font-extrabold  text-[#262626] text-center lg:text-left flex justify-center item-center">
            The leading SAP FICO training institute
          </h1>
          <p className="relative leading-[18.75px]  text-[#727272] text-[12px] md:text-[14px] text-center lg:text-left">
            SAP FICO module is WELL-ACCEPTED and covers almost all BUSINESS
            PROCEDURES EXPERIENCED in various industries
          </p>
          ...
          <div className="w-full flex flex-row items-start justify-center lg:justify-start gap-5 text-mini text-goldenrod font-font-awesome-5-free pt-[10px] pb-5">
            ...
            <div className="flex flex-row items-center justify-start gap-2 text-darkorange">
              ...
              <b className="relative leading-[18.75px]  text-[#24292D] text-[10px] lg:text-[13px]">
                12k Enrolled
              </b>
            </div>
        ...
        <div className="w-full lg:w-[30%] flex items-center lg:items-start lg:pt-[40px] ">
          <Image
            className="w-full h-full object-cover"
            src="https://eme25.s3.ap-south-1.amazonaws.com/assets/images/SAP_Course/SAP_FICO/SAP_FICO_Hero.svg"
            width={300}
            height={300}
            alt="team"
          />
