...
export default function AllSapCourseDetails({
    Courses,
    SelectCourses,
    email_sender,
    Brochure,
  ...
  const [isModalOpen, setIsModalOpen] = useState(false);
    ...
    return (
        <div className='w-full  max-w-[1380px] mx-auto flex flex-col items-start gap-[20px] py-[40px]  px-[20px] md:px-24'>
            ...
            <div className='w-full h-auto border-[1px] border-[#EEEEEE] rounded-[16px] overflow-hidden'>
                <div className='flex flex-row justify-center pt-6 pb-4 px-4'>
                    <div className='relative bg-[#e3f5fd] rounded-md box-border text-center lg:text-start text-[16px] lg:text-[24px] leading-[26px] text-[#41ABE0] font-[700]  py-[6px] lg:py-[16px] px-[18px] lg:px-[80px]'>
