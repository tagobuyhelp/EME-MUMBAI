      ...
      <div className="w-full flex flex-col items-center justify-center gap-4 md:gap-x-10">
        <div className='relative flex justify-center text-center gap-2 text-[22px] font-semibold text-[#4B4B4B]'>
          <div className="w-auto flex justify-center">
            ...
            <div className="flex flex-col items-center justify-center gap-x-2 text-[#042A76] text-[16px] md:text-[22px] leading-10 lg:leading-10 lg:text-[26px] font-bold">
              <h2>Frequently Asked Questions <span className="text-[#E87D1A]">(FAQs)</span></h2>
            </div>
