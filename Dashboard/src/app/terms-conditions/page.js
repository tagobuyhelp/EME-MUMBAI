...
export default function TermsCondition() {
  return (
    <main className="flex flex-col justify-center items-center w-full min-h-screen  ">
      ...
      <div className="w-full  min-h-screen flex flex-col  justify-start gap-[50px] items-center   md:px-24  max-w-[1380px] mx-auto">
       
          <div className="h-full w-full max-w-maxContent mx-auto bg-white text-black  py-[40px] px-6">
