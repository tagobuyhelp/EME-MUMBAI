...
const rolesData = [
  {
    title: "Data Analyst",
    desc: "Extract insights from data and drive business decisions.",
    salary: "₹4 – 8 LPA",
    growth: "+28%",
    img: "/assets/images/Home/courses/data-analytics-course-dashboard-training.webp",
  },
  {
    title: "Business Intelligence Analyst",
    desc: "Create dashboards and reports for actionable insights.",
    salary: "₹5 – 11 LPA",
    growth: "+33%",
    img: "/assets/images/Home/courses/DataAnalyticsNew.webp",
  },
  {
    title: "Machine Learning Associate",
    desc: "Build ML models and work on predictive analytics.",
    salary: "₹6 – 12 LPA",
    growth: "+45%",
    img: "/assets/images/Home/courses/data-science-course-ai-machine-learning-training.webp",
  },
  {
    title: "Marketing Analyst",
    desc: "Analyze user behavior and drive growth strategies.",
    salary: "₹4 – 9 LPA",
    growth: "+22%",
    img: "/assets/images/Home/courses/digital-marketing-course-analytics-training.webp",
  },
  {
    title: "Data Visualization Specialist",
    desc: "Turn complex data into clear visual stories.",
    salary: "₹5 – 10 LPA",
    growth: "+31%",
    img: "/assets/images/Home/courses/sap-training-course-erp-learning.webp",
  },
];
...
const footerHighlights = [
  {
    ...
    desc: "Learn skills that top companies are hiring for.",
    icon: Briefcase,
  },
  {
    title: "Real-World Projects",
    desc: "Work on 15+ projects and build a strong portfolio.",
    icon: TrendingUp,
  },
  {
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-xl sm:text-2xl md:text-[32px] font-black text-[#232D63] leading-tight tracking-tight">
              Scope of a Professional <span className="text-[#00A2E7]">AI-Based Data Analyst</span> in Kolkata
            </h2>
            <p className="text-[#64748b] text-xs sm:text-[15px] leading-relaxed max-w-3xl">
              Data is used in every industry, like fintech, IT, education, healthcare, and e-commerce. And we are filling the gap between growing industry demand and the shortage of skilled data analytics professionals.
            </p>
          </div>
