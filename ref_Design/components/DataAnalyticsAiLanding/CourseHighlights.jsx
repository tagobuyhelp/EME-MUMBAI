...
const highlightItems = [
  {
    label: "Live Classes",
    img: "/assets/images/Data_Analytics_AI/live-classes-data-analytics-ai.webp",
    icon: Video,
    bgColor: "bg-sky-100",
  ...
  },
  {
    ...
    img: "/assets/images/Data_Analytics_AI/free-study-material-data-analytics.webp",
    icon: BookOpen,
  ...
  {
    label: "15+ Projects",
    img: "/assets/images/Data_Analytics_AI/real-projects-data-analytics-ai.webp",
    icon: FolderOpen,
  ...
  },
  {
    ...
    img: "/assets/images/Data_Analytics_AI/internship-certificate-analytics.webp",
    icon: Award,
  ...
  },
  {
    ...
    img: "/assets/images/Data_Analytics_AI/mentor-support-data-analytics.webp",
    icon: Users,
  ...
  },
  {
    ...
    img: "/assets/images/Data_Analytics_AI/doubt-clearing-session.webp",
    icon: HelpCircle,
    bgColor: "bg-pink-100",
  ...
  {
    label: "Mock Tests",
    img: "/assets/images/Data_Analytics_AI/mock-test-assessment.webp",
    icon: ClipboardList,
    bgColor: "bg-teal-100",
  ...
  },
  {
    ...
    img: "/assets/images/Data_Analytics_AI/portfolio-building-data-analytics.webp",
    icon: Briefcase,
  ...
  },
  {
    ...
    img: "/assets/images/Data_Analytics_AI/placement-support-career.webp",
    icon: Handshake,
    bgColor: "bg-rose-100",
  ...
  },
  {
    ...
    img: "/assets/images/Data_Analytics_AI/personality-development-professional.webp",
    icon: TrendingUp,
    bgColor: "bg-lime-100",
        ...
        <div className="flex flex-col gap-4 sm:gap-5">
          <div className="flex flex-col gap-2.5">
            ...
            <p className="text-[#64748b] text-xs sm:text-[15px] leading-relaxed max-w-3xl">
              At EME Academy, learn directly from industry experts, work on enterprise-level projects, and build a strong portfolio that makes you job-ready from day one. From mastering data analytics tools to solving real business challenges, every step of the training is designed to help you grow with confidence and industry-ready expertise.
            </p>
          </div>
          <button
            onClick={() => {
